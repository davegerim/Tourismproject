        ...
        <div class=" container px-4 mx-auto">
          ...
          <div class="flex flex-wrap justify-center -mx-4">
            <div class="w-full md:w-1/2 lg:w-auto px-4 xl:px-10 mb-10 md:mb-0">
              <div class="max-w-sm mx-auto mt-10 h-full py-8 px-6 bg-white border border-gray-200 rounded-5xl">
            ...
            <div class="w-full md:w-1/2 lg:w-auto px-4 xl:px-10">
              <div class="max-w-sm mx-auto mt-11 h-full py-8 px-6 bg-white border border-gray-200 rounded-5xl">
                <div class="max-w-2xs mx-auto text-center">
                  <img
                    class="block mx-auto mb-3"
